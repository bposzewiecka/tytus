...
, target = 'hg38', query = 'panTro5', window = 5, outgroup = 'rheMac8',  derived = 'target', type= 'target', chromosome = chroms),
        expand('data/{query}/{target}.{query}/{type}/w{window}/outgroup.{outgroup}/ubcs_fast/{type}.{target}.{query}.{chromosome}.w{window}.derived_in_{derived}.outgroup.{outgroup}.window_size.{window_size}.compressed_bins_stats.tsv', target = 'hg38', query = 'panTro5', window = 5, outgroup = 'rheMac8',  derived = 'target', type= 'target', chromosome = chroms, window_size = 300)
